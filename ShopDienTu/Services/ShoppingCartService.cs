...
using ShopDienTu.Models; // Cần thiết cho Cart, CartItem (DB Entities) và Product, User, Promotion, Rank
using ShopDienTu.Models.ViewModels; // Cần thiết cho CartItemViewModel
